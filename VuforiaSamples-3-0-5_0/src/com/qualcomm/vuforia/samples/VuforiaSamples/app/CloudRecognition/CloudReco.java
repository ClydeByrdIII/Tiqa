...
public class CloudReco extends Activity implements SampleApplicationControl,
	...
	private void loadTextures() {
		mTextures.add(Texture.loadTextureFromApk("cat.png",
				getAssets()));
	}
	...
	public void onQCARUpdate(State state) {
		...
		if (statusCode < 0) {
			...
			if (finder.getResultCount() > 0) {
				System.out.println("here: " + finder.getResultCount());
				TargetSearchResult result = finder.getResult(0);
				System.out.println("here: " + result.getTargetName());

				// Check if this target is suitable for tracking:
				if (result.getTrackingRating() > 0) {
					System.out.println("here: " + result.getTargetName());
					System.out.println("here: " + result.getTrackingRating());
